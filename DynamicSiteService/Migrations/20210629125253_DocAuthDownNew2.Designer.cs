...
namespace DynamicSiteService.Migrations
{
    ...
    [Migration("20210629125253_DocAuthDownNew2")]
    partial class DocAuthDownNew2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ContentPage", b =>
                {
                    ...
                    b.Property<bool?>("IsBayi")
                        .HasColumnType("bit");

                    b.Property<bool?>("IsBireysel")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Documents", b =>
                {
                    ...
                    b.Property<int?>("BIMFileId")
                        .HasColumnType("int");

                    b.Property<int?>("BannerImageId")
                        .HasColumnType("int");

                    b.Property<int?>("CadDataId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("User", b =>
                {
                    ...
                    b.Property<string>("UserDocToken")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Documents", b =>
                {
                    b.HasOne("ContentPage", "BIMFile")
                        .WithMany("BIMFiles")
                        .HasForeignKey("BIMFileId");

                    b.HasOne("ContentPage", "BannerImage")
                        .WithOne("BannerImage")
                        .HasForeignKey("Documents", "BannerImageId");

                    b.HasOne("ContentPage", "CadData")
                        .WithMany("CadDatas")
                        .HasForeignKey("CadDataId");
                    ...
                    b.HasOne("ContentPage", "TechnicalDocument")
                        .WithMany("TechnicalDocuments")
                        .HasForeignKey("TechnicalDocumentId");

                    b.HasOne("ContentPage", "TechnicalProperty")
                    ...
                    b.Navigation("BIMFile");

                    b.Navigation("CadData");
            ...
            modelBuilder.Entity("ContentPage", b =>
                {
                    ...
                    b.Navigation("BIMFiles");

                    b.Navigation("CadDatas");
